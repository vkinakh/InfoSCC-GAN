...
size = 128
n_channels = 3
columns = ['Bald', 'Black_Hair', 'Blond_Hair', 'Brown_Hair', 'Gray_Hair', 'Mustache', 'Wearing_Hat', 'Eyeglasses',
           'Wearing_Necktie', 'Double_Chin']
n = len(columns)
y_size = n
...
n_cols = 4
y_type = 'multi_label'
path = './models/CelebA/celeba_generator_10.pt'
drive_id = '1mctcnfvocoLDV0sz657FOUEtRsbhQ8WC'
