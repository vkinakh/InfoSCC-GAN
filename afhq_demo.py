...
model_path = '/home/kinakh/Development/Projects/eigen-ae/logs/afhq/20210804_215558_cls_2_classes_3/checkpoints/0200000.pt'
...
label_one_hot = F.one_hot(label, num_classes=n_classes).float().to()
